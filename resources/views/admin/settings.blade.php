...
<label>Final surprise photo</label><input type="file" name="final_photo" accept="image/*">@if($settings->final_photo)<img class="form-preview" src="{{ asset('storage/'.$settings->final_photo) }}">@endif
